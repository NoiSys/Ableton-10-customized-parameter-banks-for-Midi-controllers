...
# Compiled at: 2018-01-21 01:03:41
...
SAM_BNK_NAMES = ('Volume', 'Filter', 'Filter Envelope', 'LFO 1', 'LFO 2', 'LFO 3',
                 'Oscillator', 'Pitch')
SIM_BANK1 = ('Ve Attack', 'Ve Decay', 'Ve Sustain', 'Ve Release', 'Transpose', 'S Loop Length',
...
DEVICE_DICT = {b'AudioEffectGroupDevice': RCK_BANKS, 
   b'MidiEffectGroupDevice': RCK_BANKS, b'InstrumentGroupDevice': RCK_BANKS, 
   b'DrumGroupDevice': RCK_BANKS, b'InstrumentImpulse': IMP_BANKS, 
   b'Operator': OPR_BANKS, b'UltraAnalog': ALG_BANKS, b'OriginalSimpler': SIM_BANKS, 
   b'MultiSampler': SAM_BANKS, b'MidiArpeggiator': ARP_BANKS, b'LoungeLizard': ELC_BANKS, 
   b'StringStudio': TNS_BANKS, b'Collision': COL_BANKS, b'MidiChord': CRD_BANKS, 
   b'MidiNoteLength': NTL_BANKS, b'MidiPitcher': PIT_BANKS, 
   b'MidiRandom': RND_BANKS, b'MidiScale': SCL_BANKS, b'MidiVelocity': VEL_BANKS, 
   b'AutoFilter': AFL_BANKS, b'AutoPan': APN_BANKS, b'BeatRepeat': BRP_BANKS, 
   b'Chorus': CHR_BANKS, b'Compressor2': CP3_BANKS, b'Corpus': CRP_BANKS, 
   b'Eq8': EQ8_BANKS, b'FilterEQ3': EQ3_BANKS, b'Erosion': ERO_BANKS, b'FilterDelay': FLD_BANKS, 
   b'Flanger': FLG_BANKS, b'FrequencyShifter': FRS_BANKS, b'GrainDelay': GRD_BANKS, 
   b'Looper': LPR_BANKS, b'MultibandDynamics': MBD_BANKS, b'Overdrive': OVR_BANKS, 
   b'Phaser': PHS_BANKS, b'Redux': RDX_BANKS, b'Saturator': SAT_BANKS, 
   b'Resonator': RSN_BANKS, b'CrossDelay': SMD_BANKS, b'StereoGain': UTL_BANKS, 
   b'Tube': DTB_BANKS, b'Reverb': RVB_BANKS, b'Vinyl': VDS_BANKS, b'Gate': GTE_BANKS, 
   b'PingPongDelay': PPG_BANKS, b'Vocoder': VOC_BANKS, b'Amp': AMP_BANKS, b'Cabinet': CAB_BANKS, 
   b'GlueCompressor': GLU_BANKS}
DEVICE_BOB_DICT = {b'AudioEffectGroupDevice': RCK_BOBS, 
   b'MidiEffectGroupDevice': RCK_BOBS, b'InstrumentGroupDevice': RCK_BOBS, 
   b'DrumGroupDevice': RCK_BOBS, b'InstrumentImpulse': IMP_BOBS, 
   b'Operator': OPR_BOBS, b'UltraAnalog': ALG_BOBS, b'OriginalSimpler': SIM_BOBS, 
   b'MultiSampler': SAM_BOBS, b'MidiArpeggiator': ARP_BOBS, b'LoungeLizard': ELC_BOBS, 
   b'StringStudio': TNS_BOBS, b'Collision': COL_BOBS, b'MidiChord': CRD_BOBS, 
   b'MidiNoteLength': NTL_BOBS, b'MidiPitcher': PIT_BOBS, 
   b'MidiRandom': RND_BOBS, b'MidiScale': SCL_BOBS, b'MidiVelocity': VEL_BOBS, 
   b'AutoFilter': AFL_BOBS, b'AutoPan': APN_BOBS, b'BeatRepeat': BRP_BOBS, 
   b'Chorus': CHR_BOBS, b'Compressor2': CP3_BOBS, b'Corpus': CRP_BOBS, 
   b'Eq8': EQ8_BOBS, b'FilterEQ3': EQ3_BOBS, b'Erosion': ERO_BOBS, b'FilterDelay': FLD_BOBS, 
   b'Flanger': FLG_BOBS, b'FrequencyShifter': FRS_BOBS, b'GrainDelay': GRD_BOBS, 
   b'Looper': LPR_BOBS, b'MultibandDynamics': MBD_BOBS, b'Overdrive': OVR_BOBS, 
   b'Phaser': PHS_BOBS, b'Redux': RDX_BOBS, b'Saturator': SAT_BOBS, 
   b'Resonator': RSN_BOBS, b'CrossDelay': SMD_BOBS, b'StereoGain': UTL_BOBS, 
   b'Tube': DTB_BOBS, b'Reverb': RVB_BOBS, b'Vinyl': VDS_BOBS, b'Gate': GTE_BOBS, 
   b'PingPongDelay': PPG_BOBS, b'Vocoder': VOC_BOBS, b'Amp': AMP_BOBS, b'Cabinet': CAB_BOBS, 
   b'GlueCompressor': GLU_BOBS}
BANK_NAME_DICT = {b'AudioEffectGroupDevice': RCK_BNK_NAMES, 
   b'MidiEffectGroupDevice': RCK_BNK_NAMES, b'InstrumentGroupDevice': RCK_BNK_NAMES, 
   b'DrumGroupDevice': RCK_BNK_NAMES, b'InstrumentImpulse': IMP_BNK_NAMES, 
   b'Operator': OPR_BNK_NAMES, b'UltraAnalog': ALG_BNK_NAMES, b'OriginalSimpler': SIM_BNK_NAMES, 
   b'MultiSampler': SAM_BNK_NAMES, b'MidiArpeggiator': ARP_BNK_NAMES, b'LoungeLizard': ELC_BNK_NAMES, 
   b'StringStudio': TNS_BNK_NAMES, b'Collision': COL_BNK_NAMES, b'MidiChord': CRD_BNK_NAMES, 
   b'BeatRepeat': BRP_BNK_NAMES, b'Compressor2': CP3_BNK_NAMES, b'Corpus': CRP_BNK_NAMES, 
   b'Eq8': EQ8_BNK_NAMES, b'FilterDelay': FLD_BNK_NAMES, b'Flanger': FLG_BNK_NAMES, 
   b'Gate': GTE_BNK_NAMES, b'MultibandDynamics': MBD_BNK_NAMES, b'Phaser': PHS_BNK_NAMES, 
   b'Saturator': SAT_BNK_NAMES, b'Resonator': RSN_BNK_NAMES, b'Reverb': RVB_BNK_NAMES, 
   b'Vocoder': VOC_BNK_NAMES, b'Amp': AMP_BNK_NAMES, b'GlueCompressor': GLU_BNK_NAMES, 
   b'AutoFilter': AFL_BNK_NAMES, b'StereoGain': UTL_BNK_NAMES}
