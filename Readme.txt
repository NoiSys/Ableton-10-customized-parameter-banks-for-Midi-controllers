...
The decompiled "device.py" file is a part of the _Generic Midi remote script for Ableton Live 10. It affects the instant parameter mapping for every device in Ableton for control surfaces. So you can customize your automapped parameter banks very easy in exchanging the parameter names.
