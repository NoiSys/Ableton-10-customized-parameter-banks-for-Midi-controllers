...
2. go to:
   ...
   Win: C:\ProgramData\Ableton\Live 10 Suite\Resources\MIDI Remote Scripts
...
You also can rename Bank names as desired and add Banks:
...
> a text file opens automatically with all parameters from the device shown
